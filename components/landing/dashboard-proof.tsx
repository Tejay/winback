 ...
 *
 * Renders without RevealOnScroll: the dashboard image is the centrepiece of
 * the section, and a fade-in delay can leave it briefly invisible on fast
 * scrolls. Solid from first paint is more reliable.
 */
