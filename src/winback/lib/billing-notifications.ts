...
export async function sendPlatformTrialCompleteEmail(params: {
  ...
  const text = [
    ...
    '',
    `That's real revenue back in your pocket — and proof Winback works.`,
    '',
    `Subscribe to continue:`,
    `  · Keep catching win-backs the moment a subscriber cancels`,
    `  · Keep catching payment recoveries the moment a card fails`,
    `  · Keep your full dashboard of cancellations + failed payments`,
    '',
    `  ${subscribeUrl()}`,
    '',
    `— The Winback team`,
